...
if __name__ == '__main__':
    ...
    # print(dir(experience_object1))
    chirag = Person('chirag', start_date, end_date,'SparkEighteen')
    ...
    chirag = Person('chirag', start_date, end_date, 'Google')
    print_info(chirag)
    ...
    chirag = Person('chirag', start_date, end_date, 'Amazon')

...
class Person(Experience):
    ...
    def __init__(self, name, start_date, end_date, designation):
        '''
        ...
        '''
        super().__init__(start_date, end_date,designation)
        self.name = name
    ...
    def add_experience(self, Experience_person):
        '''

        :param Experience: Experience is appended in the list of the person experience
        :return: returns list of experience
        '''
        self.list_of_experience.append(Experience_person)
        company_name = Experience_person.company_name
        no_of_days_stayed = (Experience_person.end_date - Experience_person.start_date).days
    ...
    def which_company_he_worked_most(self):
        ...
        :return:returns the person experience days in which company he worked most
        '''
